...
JUDGE_SYSTEM_INSTRUCTION = (
    ...
    "happens to exist there. Judge the retrieval, not the generated answer - a good answer can "
    "follow from mediocre context and vice versa. If the chunks are clearly about the entity or "
    "document the question concerns but that source material simply never states the specific "
    "detail being asked (a duration, a date, a number that is genuinely absent from it), that is "
    "correct retrieval of a topic where the fact isn't available - score it high (4-5), not low. "
    "Reserve low scores (1-2) for retrieval that pulled in the wrong documents, an unrelated "
    "topic, or chunks with no meaningful connection to the question. 5 = retrieval found exactly "
    "the right material to look in, whether or not that material contains the answer.\n\n"
